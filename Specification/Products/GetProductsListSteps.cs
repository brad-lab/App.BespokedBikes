...
using App.BespokedBikes.Specification.Shared;
using Microsoft.Extensions.DependencyInjection;
using NUnit.Framework;
using TechTalk.SpecFlow;
using TechTalk.SpecFlow.Assist;
using AppContext = App.BespokedBikes.Specification.Shared.AppContext;

namespace App.BespokedBikes.Specification.Products
{
    [Binding]
    public class GetProductsListSteps
    {
        ...
        public void ThenTheFollowingProductsShouldBeReturned(Table table)
        {
            ...
            for (var i = 0; i < models.Count; i++)
            {
                ...
                Assert.That(result.SalePrice,
                    Is.EqualTo(model.SalePrice));
            }
        }
    }
}
